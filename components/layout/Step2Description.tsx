...
export default function Step2Description() {
 ...
 editor.isActive("heading") ?"bg-white":""
 }`}
 >
 ...
 <Menu.Items className="absolute left-0 mt-2 w-48 origin-top-left rounded-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
 <div className="py-1">
 <Menu.Item>
 {({ active }) => (
 <button
