      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <NavigationMenu className="hidden lg:flex mx-auto">
            <NavigationMenuList className="gap-2">
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <div className="w-[1000px] p-8 bg-white grid grid-cols-12 gap-8 rounded-2xl shadow-xl border border-gray-100">
                    <div className="col-span-9 grid grid-cols-3 gap-8">
                      {/* OUR SERVICES */}
                      <div>
                        <h4 className="text-xs font-bold text-gray-400 mb-6 tracking-wider">OUR SERVICES</h4>
                        <div className="space-y-6">
                          <Link href="/services/direct-placement" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Direct Placement</h5>
                          ...
                          <Link href="/services/contract" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Contract & Freelance</h5>
                          ...
                          <Link href="/services/dedicated-teams" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Dedicated Teams</h5>
                      ...
                      {/* INDUSTRY EXPERTISE */}
                      <div>
                        <h4 className="text-xs font-bold text-gray-400 mb-6 tracking-wider">INDUSTRY EXPERTISE</h4>
                        <div className="space-y-6">
                          <Link href="/industries/tech" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Tech & Development</h5>
                          ...
                          <Link href="/industries/customer-experience" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Customer Experience</h5>
                          ...
                          <Link href="/industries/operations" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Operations & Finance</h5>
                      ...
                      {/* RESOURCE & VALUE */}
                      <div>
                        <h4 className="text-xs font-bold text-gray-400 mb-6 tracking-wider">RESOURCE & VALUE</h4>
                        <div className="space-y-6">
                          <Link href="/how-it-works" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Our Vetting Process</h5>
                            <p className="text-xs text-gray-500 leading-relaxed">We help you the most experienced industry experts.</p>
                          </Link>
                          <Link href="/pricing" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Pricing</h5>
                    ...
                    <div className="col-span-3 bg-gray-50/50 rounded-xl p-6 text-center border border-gray-100 flex flex-col items-center justify-center">
                      ...
                      <h5 className="font-bold text-gray-900 text-sm mb-2">Need Talent Fast?</h5>
                ...
                <NavigationMenuContent>
                  <div className="w-[1000px] p-8 bg-white grid grid-cols-12 gap-8 rounded-2xl shadow-xl border border-gray-100">
                    <div className="col-span-9 grid grid-cols-3 gap-8">
                      ...
                      {/* RESOURCES */}
                      <div>
                        <h4 className="text-xs font-bold text-gray-400 mb-6 tracking-wider">RESOURCES</h4>
                        <div className="space-y-6">
                          <Link href="/how-it-works" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">How It Works</h5>
                          ...
                          <Link href="/faq" className="block group">
                            <h5 className="font-bold text-gray-900 group-hover:text-[#222364] transition text-sm mb-1">Help & FAQ</h5>
                    ...
                    <div className="col-span-3 bg-gray-50/50 rounded-xl p-6 text-center border border-gray-100 flex flex-col items-center justify-center">
                      ...
                      <h5 className="font-bold text-gray-900 text-sm mb-2">Ready to Work?</h5>
          ...
          <div className="hidden lg:flex items-center gap-4 shrink-0">
            ...
            <Link href="/signup">
              <Button className="bg-[#222364] text-white hover:bg-[#1a1a4b] px-6 h-11 rounded-xl font-semibold shadow-sm">
                Create account
              </Button>
            </Link>
          </div>
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="left" className="w-80 p-0 overflow-y-auto bg-white border-r-0">
              ...
              <div className="border-t border-gray-100 p-6 space-y-4 bg-gray-50/50">
                ...
                <Link href="/signup">
                  <Button className="w-full bg-[#222364] hover:bg-[#1a1a4b] text-white h-12 rounded-xl font-semibold shadow-sm mt-3">
                    Create account
                  </Button>
                </Link>
              </div>
