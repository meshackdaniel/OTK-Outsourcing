...
export function CookiesSettingsModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-xl p-0 rounded-2xl overflow-hidden bg-white gap-0 border-0 shadow-2xl">
        ...
        <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div className="bg-gray-50/50 rounded-xl p-4 border border-gray-100 flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-1">
                <h4 className="font-semibold text-[#222364]">Strictly necessary cookies</h4>
          ...
          <div className="bg-gray-50/50 rounded-xl p-4 border border-gray-100 flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-1">
                <h4 className="font-semibold text-[#222364]">Analytics cookies</h4>
                <Switch 
          ...
          <div className="bg-gray-50/50 rounded-xl p-4 border border-gray-100 flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-1">
                <h4 className="font-semibold text-[#222364]">Advertising cookies</h4>
                <Switch 
