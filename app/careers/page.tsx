      ...
      <main>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4 lg:px-8">
            ...
            {/* Large Team Image */}
            <div className="w-full h-[400px] md:h-[600px] rounded-3xl overflow-hidden relative bg-gray-100">
              <img 
        ...
        <section id="open-positions" className="py-24 bg-white">
          <div className="max-w-6xl mx-auto px-4 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {jobs.map((job, idx) => (
                <div key={idx} className="border border-gray-100 rounded-3xl p-8 hover:border-[#f2c060] transition-colors duration-300 bg-white group cursor-pointer">
                  
                  {/* Top Row: Title & Arrow */}
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 mb-1 group-hover:text-[#222364] transition-colors">
                        {job.title}
                      </h3>
        ...
        <section className="py-20 bg-gray-50 text-center">
          <h3 className="text-gray-500 font-medium mb-10 text-sm">
