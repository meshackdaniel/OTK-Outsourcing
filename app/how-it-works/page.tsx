...
"Our platform is designed to connect world-class professionals with organizations seamlessly."
 ...
 <UserPlus className="w-8 h-8 text-[#222364]"/>
 </div>
 <div className="text-sm font-bold tracking-widest text-[#222364] uppercase mb-2">Step 01</div>
 ...
 <Link href="/register"className="inline-flex items-center gap-2 text-[#222364] font-bold text-lg hover:underline group">
 ...
 <div className="w-full lg:w-1/2">
 <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mb-6">
 <FileCheck className="w-8 h-8 text-[#222364]"/>
 </div>
 <div className="text-sm font-bold tracking-widest text-[#222364] uppercase mb-2">Step 02</div>
 ...
 <h4 className="text-xl font-black text-[#222364] mb-4">Zero Compromises</h4>
 ...
 <div className="text-sm font-bold tracking-widest text-[#222364] uppercase mb-2">Step 03</div>
 ...
 <Link href="/courses"className="inline-flex items-center gap-2 text-[#222364] font-bold text-lg hover:underline group">
 ...
 <div className="w-full lg:w-1/2">
 <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mb-6">
 <UserSearch className="w-8 h-8 text-[#222364]"/>
 </div>
 <div className="text-sm font-bold tracking-widest text-[#222364] uppercase mb-2">Step 04</div>
 ...
 <div className="bg-gray-50 p-8 rounded-3xl">
 <h4 className="text-xl font-black text-[#222364] mb-4">Precision Hiring</h4>
 <p className="text-[#222364]">
 ...
 <div className="w-full lg:w-1/2">
 <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mb-6">
 <Briefcase className="w-8 h-8 text-[#222364]"/>
 </div>
 <div className="text-sm font-bold tracking-widest text-[#222364] uppercase mb-2">Step 05</div>
 ...
 <div className="w-full lg:w-1/2">
 <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mb-6">
 <Clock className="w-8 h-8 text-[#222364]"/>
 </div>
 <div className="text-sm font-bold tracking-widest text-[#222364] uppercase mb-2">Step 06</div>
 ...
 <div className="bg-gray-50 p-8 rounded-3xl">
 <h4 className="text-xl font-black text-[#222364] mb-4">Milestone Driven</h4>
 <p className="text-[#222364]">
 ...
 <div className="text-5xl md:text-6xl font-black text-[#f2c060] mb-4">500+</div>
 <div className="text-lg font-bold text-white mb-2">Active Employers</div>
 <p className="text-gray-500 text-sm">Hiring top talent weekly.</p>
 </div>
 <div className="pt-8 md:pt-0">
 <div className="text-5xl md:text-6xl font-black text-[#f2c060] mb-4">15k+</div>
 <div className="text-lg font-bold text-white mb-2">Posted Jobs</div>
 <p className="text-gray-500 text-sm">Opportunities across all industries.</p>
 </div>
 <div className="pt-8 md:pt-0">
 <div className="text-5xl md:text-6xl font-black text-[#f2c060] mb-4">200+</div>
 <div className="text-lg font-bold text-white mb-2">Hiring Companies</div>
 <p className="text-gray-500 text-sm">Global brands trusting OTK.</p>
 </div>
 <div className="pt-8 md:pt-0">
 <div className="text-5xl md:text-6xl font-black text-[#f2c060] mb-4">2k+</div>
 <div className="text-lg font-bold text-white mb-2">Skilled Talents</div>
 <p className="text-gray-500 text-sm">Pre-vetted and ready to work.</p>
 </div>
 </div>
 </div>
 </section>
