...
function SortableStage({
 ...
 className="flex-1 bg- border-0 focus:ring-0 focus-visible:ring-0"
...
"skillLevel",
 ...
 <p
 className={cn(
"ms-1.5 text-xs hidden md:block",
...
"basis-5/6 h-11 bg-gray-50 py-5 rounded-xl",
 ...
 <div className="flex flex-col md:flex-row mt-3 w-full gap-2 md:gap-0">
...
"bg-white rounded-xl mt-2 min-h-96",
 ...
 <h2 className="text-base font-black text-gray-900">Job Details</h2>
 ...
 <div className="px-8 py-6 border-b border-gray-100">
 <div className="flex items-center justify-between mb-4">
 <h2 className="text-base font-black text-gray-900">Job Description</h2>
 ...
 <div className="px-8 py-6 border-b border-gray-100">
 <div className="flex items-center justify-between mb-4">
 <h2 className="text-base font-black text-gray-900">Hiring Stages</h2>
 ...
 <h2 className="text-base font-black text-gray-900">Application Form</h2>
