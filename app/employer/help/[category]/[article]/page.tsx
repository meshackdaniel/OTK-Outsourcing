...
export default function EmployerArticlePage() {
    ...
    <DashboardLayout type="employer">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="flex items-center gap-2 text-sm font-semibold mb-6 flex-wrap">
          <Link href="/employer/help" className="flex items-center gap-2 text-gray-500 hover:text-[#222364] transition">
            <ArrowLeft className="w-4 h-4" />
            Help Center
          </Link>
          <ChevronRight className="w-4 h-4 text-gray-400" />
          <Link href={`/employer/help/${categorySlug}`} className="text-gray-500 hover:text-[#222364] transition">
            {categoryTitle}
          </Link>
          <ChevronRight className="w-4 h-4 text-gray-400" />
        ...
        <article className="bg-white rounded-3xl p-8 md:p-12 border border-gray-100">
          ...
          <div className="prose prose-blue max-w-none text-gray-600 leading-loose">
            <p className="text-lg text-gray-700 mb-8 font-medium">
              This guide provides a comprehensive overview of how to manage {articleTitle.toLowerCase()} effectively on the OTK Outsourcing platform. Whether you are a new employer or a seasoned enterprise client, these steps will help streamline your workflow.
            </p>

            <h3 className="text-xl font-black text-gray-900 mt-8 mb-4">Step 1: Getting Started</h3>
            <p className="mb-6">
              Begin by navigating to your primary dashboard. Ensure that your account has the necessary permissions. If you are part of an enterprise team, verify with your administrator that you have the appropriate access levels to perform actions related to {categoryTitle.toLowerCase()}.
            </p>
            ...
            <div className="bg-gray-50/50 rounded-2xl p-6 border border-blue-100 my-8">
              ...
              <p className="text-sm text-blue-800 m-0">
                Always double-check your inputs before finalizing submissions. Changes to critical settings may require a 24-hour verification window for security purposes.
              </p>
            </div>
            ...
            <ul className="list-disc pl-6 mb-8 space-y-2">
              ...
              <li>Click "Save & Continue" to securely commit your changes to the database.</li>
            </ul>
