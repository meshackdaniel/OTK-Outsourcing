...
export default function EmployerHelpPage() {
 ...
 <Link href={`/employer/help/${cat.id}`} key={i} className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-[#222364]/30 transition group block">
 ...
 <h3 className="font-black text-lg mb-2">Employer Forum</h3>
