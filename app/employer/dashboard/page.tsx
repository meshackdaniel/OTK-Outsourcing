...
"mt-4 inline-flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded-md self-start",
 ...
 <div>
 <h2 className="text-xl font-black text-[#222364]">Recruitment Funnel</h2>
 ...
 <div className="flex items-center justify-between mb-6">
 <h2 className="text-xl font-black text-[#222364]">Activity Logs</h2>
 ...
 <div className="w-8 h-8 rounded-full bg-gray-50 text-[#222364] flex items-center justify-center shrink-0 mt-1">
 <Activity className="w-4 h-4"/>
 </div>
 <div>
 <h3 className="font-black text-gray-900 text-sm">{log.title}</h3>
 ...
 <div className="flex items-center justify-between mb-6">
 <h2 className="text-xl font-black text-[#222364]">Your Active Jobs</h2>
