...
export default function SupportChatPage() {
  return (
    <DashboardLayout type="talent">
      <div className="bg-white rounded-2xl border border-gray-100 flex flex-col w-full overflow-hidden h-[calc(100vh-10rem)] max-w-4xl mx-auto shadow-sm">
        ...
        <div className="p-4 md:p-6 border-b border-gray-100 bg-white flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900 text-lg">OaaS Support</h3>
        ...
        <div className="flex-1 p-6 overflow-y-auto space-y-6 bg-gray-50/50">
          <div className="flex justify-center">
            <span className="text-xs font-semibold text-gray-500 bg-white border border-gray-100 px-4 py-1.5 rounded-full shadow-sm">
              Today
            </span>
          </div>
        ...
        <div className="p-4 bg-white border-t border-gray-100">
          <div className="flex items-center gap-2 bg-gray-50 p-2 rounded-2xl border border-gray-100 focus-within:border-[#222364]/30 focus-within:ring-4 focus-within:ring-[#222364]/5 transition-all">
            ...
            />
            <Button className="bg-[#222364] hover:bg-[#1a1b4b] text-white rounded-xl px-5 shadow-sm shrink-0">
