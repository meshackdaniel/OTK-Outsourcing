            ...
            {filteredCategories.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {filteredCategories.map((cat, i) => (
                  <Link href={`/talent/help/${cat.id}`} key={i} className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-[#222364]/30 hover:shadow-sm transition group block">
