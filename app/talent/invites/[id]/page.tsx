      ...
      <div className="relative pb-32">
              ...
              <div className="bg-white rounded-3xl p-8 border border-gray-100">
                ...
                <div className="flex justify-between items-start mb-8 pb-8 border-b border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h1 className="text-2xl font-bold text-gray-900">Backend Engineer</h1>
                ...
                {/* Job Description */}
                <div className="mb-8">
                  <h3 className="font-bold text-gray-900 text-lg mb-4">Job Description</h3>
                ...
                {/* Required Skills */}
                <div>
                  <h3 className="font-bold text-gray-900 text-lg mb-4">Required Skills</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-3xl p-6 border border-gray-100">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 text-lg">Nexus Global</h4>
              ...
              <div className="bg-[#f8f8fb] rounded-3xl p-6 border border-gray-200/60">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h4 className="font-bold text-[#222364]">Portal Pro Tip</h4>
                </div>
        ...
        <div className="fixed bottom-0 left-0 md:left-64 right-0 bg-white border-t border-gray-200 p-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4 z-40">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <Button className="flex-1 md:flex-none rounded-xl bg-[#222364] hover:bg-[#1a1b4b] text-white font-bold px-10 py-5 shadow-sm">
              Apply
            </Button>
          </div>
        </div>
