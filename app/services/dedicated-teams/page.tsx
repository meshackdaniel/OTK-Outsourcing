        ...
        <section className="pt-24 lg:pt-32 pb-16 px-4 lg:px-8 max-w-7xl mx-auto text-center">
          <FadeIn>
            <h1 className="text-5xl md:text-7xl lg:text-[5rem] font-black tracking-tight leading-[1.1] mb-8 text-[#222364]">
              Fully Managed <br />
              <span className="text-[#222364]">Remote Departments.</span>
            </h1>
          </FadeIn>
          <FadeIn delay={0.1}>
          ...
          <FadeIn className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="bg-[#F8F5FB] p-8 rounded-3xl">
                <h4 className="text-xl font-black text-[#222364] mb-4">Transparent Pricing</h4>
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="grid md:grid-cols-3 gap-12 text-center divide-y md:divide-y-0 md:divide-x divide-white/20">
              <div className="pt-8 md:pt-0">
                <div className="text-6xl md:text-7xl font-black text-[#f2c060] mb-4">60%</div>
                <div className="text-xl font-bold text-white mb-2">Cost Savings</div>
                <p className="text-gray-500">Average reduction in operational overhead.</p>
              </div>
              <div className="pt-8 md:pt-0">
                <div className="text-6xl md:text-7xl font-black text-[#f2c060] mb-4">98%</div>
                <div className="text-xl font-bold text-white mb-2">Retention Rate</div>
                <p className="text-gray-500">We keep your dedicated team happy and engaged.</p>
              </div>
              <div className="pt-8 md:pt-0">
                <div className="text-6xl md:text-7xl font-black text-[#f2c060] mb-4">24/7</div>
                <div className="text-xl font-bold text-white mb-2">IT & HR Support</div>
                <p className="text-gray-500">Round-the-clock infrastructure monitoring.</p>
              </div>
            </div>
          </div>
        </section>
