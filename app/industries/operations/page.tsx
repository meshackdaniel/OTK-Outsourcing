...
export default function OperationsPage() {
 ...
 Streamlined <br />
 <span className="text-[#222364]">Operations & Finance.</span>
 </h1>
 </FadeIn>
 <FadeIn delay={0.1}>
 ...
 <div className="w-full h-[500px] md:h-[700px] bg-slate-200 rounded-[2rem] overflow-hidden relative">
...
"Your back-office is the backbone of your business. We provide the expertise to keep it unbreakable."
 ...
 <h4 className="text-xl font-black text-slate-900 mb-4">Culture First</h4>
 ...
 <div className="text-6xl md:text-7xl font-black text-[#222364] mb-4">100%</div>
 ...
 <div className="pt-8 md:pt-0">
 <div className="text-6xl md:text-7xl font-black text-[#222364] mb-4">0</div>
 ...
 <div className="pt-8 md:pt-0">
 <div className="text-6xl md:text-7xl font-black text-[#222364] mb-4">5x</div>
